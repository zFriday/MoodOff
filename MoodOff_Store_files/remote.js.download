...
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},e5=function(){var a=XKa();
a&&a(!1,"No cast extension found")},f5=function(){if(aLa){var a=2,b=XKa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;YKa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",e5,c)}},bLa=function(){f5();
var a=$Ka();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");d5(a)},dLa=function(){f5();
var a=$Ka();a.push.apply(a,g.ma(cLa.map(ZKa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");d5(a)},g5=function(a,b,c){g.F.call(this);
...
a.Ff&&(c=null);var d=(0,g.C)(a.SS,a);c||(c=new g.Um("//www.google.com/images/cleardot.gif"),K4(c));qLa(c.toString(),1E4,d)}else n5(2);OLa(a,b)},OLa=function(a,b){a.gb=0;
